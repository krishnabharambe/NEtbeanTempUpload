...
public class mytranscation {
    ...
    public mytranscation() {
    }

    public mytranscation(String id, String CustomerId, String InvoiceId, String StockId, String StockTitle, String StockHSN, String StockCost, String StockPrice, String Discount, String StockCGST, String StockSGST, String StockGST, String Quantity, String Total) {
        this.id = id;
